		...
		<div id="list-event" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="postEventOn" title="${message(code: 'event.postEventOn.label', default: 'Post Event On')}" />
					
						<g:sortableColumn property="eventOccursOn" title="${message(code: 'event.eventOccursOn.label', default: 'Event Occurs On')}" />
					
						<g:sortableColumn property="maximumCapacity" title="${message(code: 'event.maximumCapacity.label', default: 'Maximum Capacity')}" />
				...
				<g:each in="${eventInstanceList}" status="i" var="eventInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${eventInstance.postEventOn}" /></td>
					
						<td><g:formatDate date="${eventInstance.eventOccursOn}" /></td>
					
						<td>${fieldValue(bean: eventInstance, field: "maximumCapacity")}</td>
